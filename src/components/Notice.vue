...
<template>
  <div class="accordion" id="accordionAffordable">
    <div v-for="(notice, i) in notices.data" :key="i" class="accordion-item">
      <div v-if="notice.fields.ApprovedByPRSWeb">
        ...
        >
          <div class="accordion-body">
            <p><strong>Description: </strong>{{ notice.fields.Description }}</p>
            ...
            <div v-if="notice.fields.SpanishVersion === 'Yes'">
              ...
              <p>
                <strong>
                  {{ notice.fields.SpanishName }} - disponible para comentarios
                  públicos hasta
